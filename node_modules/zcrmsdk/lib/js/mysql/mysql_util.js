...
mysql_util.saveOAuthTokens = function(config_obj) {
  return new Promise(function(resolve, reject) {
    ...
    var sql =
      ...
      config_obj.user_identifier +
      "','" +
      config_obj.access_token +
      "','" +
      config_obj.refresh_token +
      "'," +
      config_obj.expires_in +
      ")";
...
mysql_util.getOAuthTokens = function() {
  return new Promise(function(resolve, reject) {
    ...
    con.connect(function(err) {
      ...
      var sql =
        "Select * from oauthtokens where useridentifier = '" +
        crmclient.getUserIdentifier() +
        "'";
...
mysql_util.updateOAuthTokens = function(config_obj) {
  return new Promise(function(resolve, reject) {
    ...
    con.connect(function(err) {
      ...
      var sql =
        "update oauthtokens set accesstoken = '" +
        config_obj.access_token +
        "' , expirytime=" +
        config_obj.expires_in +
...
mysql_util.deleteOAuthTokens = function() {
  return new Promise(function(resolve, reject) {
    ...
    var crmclient = require("../ZCRMRestClient");
    var user = crmclient.getUserIdentifier();
    var sql = "delete from oauthtokens where useridentifier='" + user + "'";
...
mysql_util.getConnection = function() {
  var con = mysql.createConnection({
    host: "localhost",
    user: ZCRMRestClient.getMySQLUserName(),
    password: ZCRMRestClient.getMYSQLPassword(),
    database: "zohooauth"
  });
  return con;
};
